...
namespace AssignmentTwo
{
    class Addition
    {
        ...
        public string Add(string firstNumber, string secondNumber)
        {
            ...
            value sumEnum;
            StringBuilder firstNumberBuilder = new StringBuilder(manipulationObject.ReverseString(firstNumber));
            StringBuilder secondNumberBuilder = new StringBuilder(manipulationObject.ReverseString(secondNumber));
